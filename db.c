...
init_db (void)
{
    ...
    snprintf (Buf, sizeof (Buf),
	      "CREATE TABLE library (owner VARCHAR(15) NOT NULL, filename VARCHAR(240) NOT NULL, size INT UNSIGNED, md5 VARCHAR(48), bitrate INT UNSIGNED, freq INT UNSIGNED, time INT UNSIGNED, linespeed INT UNSIGNED, soundex VARCHAR(255), PRIMARY KEY (owner, filename))");
