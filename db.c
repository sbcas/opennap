...
init_db (void)
{
    ...
    snprintf (Buf, sizeof (Buf),
	      "CREATE TABLE library (owner VARCHAR(255), filename VARCHAR(255), size INT UNSIGNED, md5 VARCHAR(48), bitrate INT UNSIGNED, freq INT UNSIGNED, time INT UNSIGNED, linespeed INT UNSIGNED)");
